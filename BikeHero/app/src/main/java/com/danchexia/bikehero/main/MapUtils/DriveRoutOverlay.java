...
public class DriveRoutOverlay extends OverlayManager {

    private DrivingRouteLine mRouteLine = null;

    public DriveRoutOverlay(BaiduMap baiduMap) {
        super(baiduMap);
    }
     ...
     *            路线数据
     */
    public void setData(DrivingRouteLine line) {
        mRouteLine = line;
    }
            ...
            for (DrivingRouteLine.DrivingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(10)
                            .color(getLineColor() != 0 ? getLineColor() : Color.argb(255, 255, 0, 0)).zIndex(0));
