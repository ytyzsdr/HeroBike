...
public class MyTripLIstActivity extends MvpActivity<MyTripListPresenter , IMyTripListView> implements IMyTripListView, View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    protected MyTripListPresenter CreatePresenter() {
        return presenter = new MyTripListPresenter(this);
    }
            ...
            public void run() {
                ...
                if (dataList.size() == 0){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            if (adapter == null) {
                                adapter = new ItemStrokeAdapter(MyTripLIstActivity.this, dataList);
