...
public class WalkingRoutOverlay extends OverlayManager {

    private WalkingRouteLine mRouteLine = null;

    public WalkingRoutOverlay(BaiduMap baiduMap) {
        super(baiduMap);
    }
            ...
            for (WalkingRouteLine.WalkingStep step : mRouteLine.getAllStep()) {
                ...
                if (watPoints != null) {
                    ...
                    overlayList.add(new PolylineOptions().points(points).width(10)
                            .color(getLineColor() != 0 ? getLineColor() : Color.argb(255, 0, 144, 255)).zIndex(0));
