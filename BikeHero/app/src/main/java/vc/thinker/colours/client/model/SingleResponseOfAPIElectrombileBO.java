...
/*     */ 
/*     */
/*     */ public class SingleResponseOfAPIElectrombileBO
/*     */ {
...
/*     */   
/*     */   @SerializedName("item")
/*  22 */   private APIElectrombileBO item = null;
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public APIElectrombileBO getItem()
/*     */   {
/*  56 */     return this.item;
/*     */   }
/*     */   
/*  59 */   public void setItem(APIElectrombileBO item) { this.item = item; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  81 */       return false;
/*     */     }
/*  83 */     SingleResponseOfAPIElectrombileBO singleResponseOfAPIElectrombileBO = (SingleResponseOfAPIElectrombileBO)o;
/*  84 */     return (Objects.equals(this.error, singleResponseOfAPIElectrombileBO.error)) && 
/*  85 */       (Objects.equals(this.errorDescription, singleResponseOfAPIElectrombileBO.errorDescription)) && 
/*  86 */       (Objects.equals(this.item, singleResponseOfAPIElectrombileBO.item)) && 
/*  87 */       (Objects.equals(this.success, singleResponseOfAPIElectrombileBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  98 */     sb.append("class SingleResponseOfAPIElectrombileBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\SingleResponseOfAPIElectrombileBO.class
