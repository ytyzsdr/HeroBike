...
/*     */ 
/*     */
/*     */ public class ListResponseOfRequestResult
/*     */ {
...
/*  23 */   private List<RequestResult> items = new ArrayList();
/*     */   
...
/*     */   }
/*     */   
/*  60 */   public void setItems(List<RequestResult> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfRequestResult listResponseOfRequestResult = (ListResponseOfRequestResult)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfRequestResult.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfRequestResult.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfRequestResult.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfRequestResult.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfRequestResult {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfRequestResult.class
