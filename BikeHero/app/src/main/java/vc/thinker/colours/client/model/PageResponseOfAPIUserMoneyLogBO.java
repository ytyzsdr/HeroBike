...
/*     */ 
/*     */
/*     */ public class PageResponseOfAPIUserMoneyLogBO
/*     */ {
/*     */   @SerializedName("content")
/*  18 */   private List<APIUserMoneyLogBO> content = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIUserMoneyLogBO> getContent()
/*     */   {
/*  57 */     return this.content;
/*     */   }
/*     */   
/*  60 */   public void setContent(List<APIUserMoneyLogBO> content) { this.content = content; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 181 */       return false;
/*     */     }
/* 183 */     PageResponseOfAPIUserMoneyLogBO pageResponseOfAPIUserMoneyLogBO = (PageResponseOfAPIUserMoneyLogBO)o;
/* 184 */     return (Objects.equals(this.content, pageResponseOfAPIUserMoneyLogBO.content)) && 
/* 185 */       (Objects.equals(this.error, pageResponseOfAPIUserMoneyLogBO.error)) && 
/* 186 */       (Objects.equals(this.errorDescription, pageResponseOfAPIUserMoneyLogBO.errorDescription)) && 
/* 187 */       (Objects.equals(this.first, pageResponseOfAPIUserMoneyLogBO.first)) && 
/* 188 */       (Objects.equals(this.last, pageResponseOfAPIUserMoneyLogBO.last)) && 
/* 189 */       (Objects.equals(this.number, pageResponseOfAPIUserMoneyLogBO.number)) && 
/* 190 */       (Objects.equals(this.searchDate, pageResponseOfAPIUserMoneyLogBO.searchDate)) && 
/* 191 */       (Objects.equals(this.size, pageResponseOfAPIUserMoneyLogBO.size)) && 
/* 192 */       (Objects.equals(this.success, pageResponseOfAPIUserMoneyLogBO.success)) && 
/* 193 */       (Objects.equals(this.totalElements, pageResponseOfAPIUserMoneyLogBO.totalElements)) && 
/* 194 */       (Objects.equals(this.totalPages, pageResponseOfAPIUserMoneyLogBO.totalPages));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/* 205 */     sb.append("class PageResponseOfAPIUserMoneyLogBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\PageResponseOfAPIUserMoneyLogBO.class
