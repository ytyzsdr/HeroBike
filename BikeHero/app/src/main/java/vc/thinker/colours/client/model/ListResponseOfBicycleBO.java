...
/*     */ 
/*     */
/*     */ public class ListResponseOfBicycleBO
/*     */ {
...
/*  23 */   private List<BicycleBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<BicycleBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<BicycleBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfBicycleBO listResponseOfBicycleBO = (ListResponseOfBicycleBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfBicycleBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfBicycleBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfBicycleBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfBicycleBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfBicycleBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfBicycleBO.class
