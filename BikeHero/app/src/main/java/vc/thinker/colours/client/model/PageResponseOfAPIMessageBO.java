...
/*     */ 
/*     */
/*     */ public class PageResponseOfAPIMessageBO
/*     */ {
/*     */   @SerializedName("content")
/*  18 */   private List<APIMessageBO> content = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIMessageBO> getContent()
/*     */   {
/*  57 */     return this.content;
/*     */   }
/*     */   
/*  60 */   public void setContent(List<APIMessageBO> content) { this.content = content; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 181 */       return false;
/*     */     }
/* 183 */     PageResponseOfAPIMessageBO pageResponseOfAPIMessageBO = (PageResponseOfAPIMessageBO)o;
/* 184 */     return (Objects.equals(this.content, pageResponseOfAPIMessageBO.content)) && 
/* 185 */       (Objects.equals(this.error, pageResponseOfAPIMessageBO.error)) && 
/* 186 */       (Objects.equals(this.errorDescription, pageResponseOfAPIMessageBO.errorDescription)) && 
/* 187 */       (Objects.equals(this.first, pageResponseOfAPIMessageBO.first)) && 
/* 188 */       (Objects.equals(this.last, pageResponseOfAPIMessageBO.last)) && 
/* 189 */       (Objects.equals(this.number, pageResponseOfAPIMessageBO.number)) && 
/* 190 */       (Objects.equals(this.searchDate, pageResponseOfAPIMessageBO.searchDate)) && 
/* 191 */       (Objects.equals(this.size, pageResponseOfAPIMessageBO.size)) && 
/* 192 */       (Objects.equals(this.success, pageResponseOfAPIMessageBO.success)) && 
/* 193 */       (Objects.equals(this.totalElements, pageResponseOfAPIMessageBO.totalElements)) && 
/* 194 */       (Objects.equals(this.totalPages, pageResponseOfAPIMessageBO.totalPages));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/* 205 */     sb.append("class PageResponseOfAPIMessageBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\PageResponseOfAPIMessageBO.class
