...
/*     */ 
/*     */
/*     */ public class ListResponseOfFeedbackTypeBO
/*     */ {
...
/*  23 */   private List<FeedbackTypeBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<FeedbackTypeBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<FeedbackTypeBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfFeedbackTypeBO listResponseOfFeedbackTypeBO = (ListResponseOfFeedbackTypeBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfFeedbackTypeBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfFeedbackTypeBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfFeedbackTypeBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfFeedbackTypeBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfFeedbackTypeBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfFeedbackTypeBO.class
