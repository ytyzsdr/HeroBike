...
/*     */ 
/*     */
/*     */ public class ListResponseOfUserCouponBO
/*     */ {
...
/*  23 */   private List<UserCouponBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<UserCouponBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<UserCouponBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfUserCouponBO listResponseOfUserCouponBO = (ListResponseOfUserCouponBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfUserCouponBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfUserCouponBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfUserCouponBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfUserCouponBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfUserCouponBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfUserCouponBO.class
