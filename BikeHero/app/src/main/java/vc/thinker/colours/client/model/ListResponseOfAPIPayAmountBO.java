...
/*     */ 
/*     */
/*     */ public class ListResponseOfAPIPayAmountBO
/*     */ {
...
/*  23 */   private List<APIPayAmountBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIPayAmountBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIPayAmountBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIPayAmountBO listResponseOfAPIPayAmountBO = (ListResponseOfAPIPayAmountBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIPayAmountBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIPayAmountBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIPayAmountBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIPayAmountBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIPayAmountBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIPayAmountBO.class
