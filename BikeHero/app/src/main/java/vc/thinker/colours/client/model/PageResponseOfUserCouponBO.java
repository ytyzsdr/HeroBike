...
/*  18 */   private List<UserCouponBO> content = new ArrayList();
/*     */   
...
/*     */   }
/*     */   
/*  60 */   public void setContent(List<UserCouponBO> content) { this.content = content; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 181 */       return false;
/*     */     }
/* 183 */     PageResponseOfUserCouponBO pageResponseOfUserCouponBO = (PageResponseOfUserCouponBO)o;
/* 184 */     return (Objects.equals(this.content, pageResponseOfUserCouponBO.content)) && 
/* 185 */       (Objects.equals(this.error, pageResponseOfUserCouponBO.error)) && 
/* 186 */       (Objects.equals(this.errorDescription, pageResponseOfUserCouponBO.errorDescription)) && 
/* 187 */       (Objects.equals(this.first, pageResponseOfUserCouponBO.first)) && 
/* 188 */       (Objects.equals(this.last, pageResponseOfUserCouponBO.last)) && 
/* 189 */       (Objects.equals(this.number, pageResponseOfUserCouponBO.number)) && 
/* 190 */       (Objects.equals(this.searchDate, pageResponseOfUserCouponBO.searchDate)) && 
/* 191 */       (Objects.equals(this.size, pageResponseOfUserCouponBO.size)) && 
/* 192 */       (Objects.equals(this.success, pageResponseOfUserCouponBO.success)) && 
/* 193 */       (Objects.equals(this.totalElements, pageResponseOfUserCouponBO.totalElements)) && 
/* 194 */       (Objects.equals(this.totalPages, pageResponseOfUserCouponBO.totalPages));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/* 205 */     sb.append("class PageResponseOfUserCouponBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\PageResponseOfUserCouponBO.class
