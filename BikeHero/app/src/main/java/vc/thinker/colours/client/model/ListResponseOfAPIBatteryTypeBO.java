...
/*     */ 
/*     */
/*     */ public class ListResponseOfAPIBatteryTypeBO
/*     */ {
...
/*  23 */   private List<APIBatteryTypeBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIBatteryTypeBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIBatteryTypeBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIBatteryTypeBO listResponseOfAPIBatteryTypeBO = (ListResponseOfAPIBatteryTypeBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIBatteryTypeBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIBatteryTypeBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIBatteryTypeBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIBatteryTypeBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIBatteryTypeBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIBatteryTypeBO.class
