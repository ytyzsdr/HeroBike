...
/*     */ 
/*     */
/*     */ public class ListResponseOfAPIFaultTypeBO
/*     */ {
...
/*  23 */   private List<APIFaultTypeBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIFaultTypeBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIFaultTypeBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIFaultTypeBO listResponseOfAPIFaultTypeBO = (ListResponseOfAPIFaultTypeBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIFaultTypeBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIFaultTypeBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIFaultTypeBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIFaultTypeBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIFaultTypeBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIFaultTypeBO.class
