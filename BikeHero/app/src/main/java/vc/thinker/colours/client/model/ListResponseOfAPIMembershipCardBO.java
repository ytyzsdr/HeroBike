...
/*     */ 
/*     */
/*     */ public class ListResponseOfAPIMembershipCardBO
/*     */ {
...
/*  23 */   private List<APIMembershipCardBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIMembershipCardBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIMembershipCardBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIMembershipCardBO listResponseOfAPIMembershipCardBO = (ListResponseOfAPIMembershipCardBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIMembershipCardBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIMembershipCardBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIMembershipCardBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIMembershipCardBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIMembershipCardBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIMembershipCardBO.class
