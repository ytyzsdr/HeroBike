...
/*  18 */   private List<APIOrderWorkBO> content = new ArrayList();
/*     */   
...
/*     */   }
/*     */   
/*  60 */   public void setContent(List<APIOrderWorkBO> content) { this.content = content; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/* 181 */       return false;
/*     */     }
/* 183 */     PageResponseOfAPIOrderWorkBO pageResponseOfAPIOrderWorkBO = (PageResponseOfAPIOrderWorkBO)o;
/* 184 */     return (Objects.equals(this.content, pageResponseOfAPIOrderWorkBO.content)) && 
/* 185 */       (Objects.equals(this.error, pageResponseOfAPIOrderWorkBO.error)) && 
/* 186 */       (Objects.equals(this.errorDescription, pageResponseOfAPIOrderWorkBO.errorDescription)) && 
/* 187 */       (Objects.equals(this.first, pageResponseOfAPIOrderWorkBO.first)) && 
/* 188 */       (Objects.equals(this.last, pageResponseOfAPIOrderWorkBO.last)) && 
/* 189 */       (Objects.equals(this.number, pageResponseOfAPIOrderWorkBO.number)) && 
/* 190 */       (Objects.equals(this.searchDate, pageResponseOfAPIOrderWorkBO.searchDate)) && 
/* 191 */       (Objects.equals(this.size, pageResponseOfAPIOrderWorkBO.size)) && 
/* 192 */       (Objects.equals(this.success, pageResponseOfAPIOrderWorkBO.success)) && 
/* 193 */       (Objects.equals(this.totalElements, pageResponseOfAPIOrderWorkBO.totalElements)) && 
/* 194 */       (Objects.equals(this.totalPages, pageResponseOfAPIOrderWorkBO.totalPages));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/* 205 */     sb.append("class PageResponseOfAPIOrderWorkBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\PageResponseOfAPIOrderWorkBO.class
