...
/*  23 */   private List<APIBatteryBO> items = new ArrayList();
/*     */   
...
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIBatteryBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIBatteryBO listResponseOfAPIBatteryBO = (ListResponseOfAPIBatteryBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIBatteryBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIBatteryBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIBatteryBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIBatteryBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIBatteryBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIBatteryBO.class
