...
/*     */ 
/*     */
/*     */ public class ListResponseOfAPIElectrombileBO
/*     */ {
...
/*  23 */   private List<APIElectrombileBO> items = new ArrayList();
/*     */   
...
/*     */ 
/*     */   //("")
/*     */   public List<APIElectrombileBO> getItems()
/*     */   {
/*  57 */     return this.items;
/*     */   }
/*     */   
/*  60 */   public void setItems(List<APIElectrombileBO> items) { this.items = items; }
/*     */   
/*     */ 
/*     */ 
/*     */ 
...
/*  82 */       return false;
/*     */     }
/*  84 */     ListResponseOfAPIElectrombileBO listResponseOfAPIElectrombileBO = (ListResponseOfAPIElectrombileBO)o;
/*  85 */     return (Objects.equals(this.error, listResponseOfAPIElectrombileBO.error)) && 
/*  86 */       (Objects.equals(this.errorDescription, listResponseOfAPIElectrombileBO.errorDescription)) && 
/*  87 */       (Objects.equals(this.items, listResponseOfAPIElectrombileBO.items)) && 
/*  88 */       (Objects.equals(this.success, listResponseOfAPIElectrombileBO.success));
/*     */   }
/*     */   
/*     */   public int hashCode()
/*     */   {
...
/*  99 */     sb.append("class ListResponseOfAPIElectrombileBO {\n");
/*     */     
...
/* Location:              C:\Users\Administrator\Desktop\android-sdk-client-1.0.jar!\vc\thinker\colours\client\model\ListResponseOfAPIElectrombileBO.class
